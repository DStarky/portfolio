    ...
    <section className="pb-16">
      <div className="container">
        ...
        <p className="mx-auto mt-4 max-w-md text-center text-white/60 md:text-lg">
          See how I transformed concepts into engaging digital experrience.
        </p>
        <div className="mt-10 flex flex-col gap-20 md:mt-20">
          {portfolioProjects.map(project => (
            <div
              key={project.title}
              className="relative z-0 overflow-hidden rounded-3xl bg-gray-800 px-8 pt-8 after:pointer-events-none after:absolute after:inset-0 after:z-10 after:rounded-3xl after:outline after:outline-2 after:-outline-offset-2 after:outline-white/20 after:content-[''] md:px-10 md:pt-12"
            >
              <div
              ...
              <a href={project.link}>
                <button className="font-semibol mt-8 inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-white text-gray-950 md:w-auto md:px-6">
